...
public class Data {
    ...
    public static void create20NewsCorpus(String fileName, String blackListFile) throws IOException {
        BufferedReader reader = new BufferedReader(
    ...
    public static void createVectorsFor20News() throws IOException {
    ...
    public static void createNIPSDataset(String inputFile, String outputFile) throws IOException {
    ...
    public static void createNIPSVectors() throws IOException {
